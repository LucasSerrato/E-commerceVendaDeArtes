    ...
    <footer className={styles.footer}>
      <div className={styles.footerContainer}>
        ...
        <div className={styles.footerSection}>
          ...
          <ul>
            <li>
              <a href="mailto:freemix.br@gmail.com">freemix.br@gmail.com</a>
            </li>
          </ul>

          <div className={styles.socialIcons}>
            <a
              href="https://www.instagram.com/freemix"
              target="_blank"
            ...
            <a
              href="https://www.linkedin.com/company/freemix"
              target="_blank"
              rel="noopener noreferrer"
            >
              <img
