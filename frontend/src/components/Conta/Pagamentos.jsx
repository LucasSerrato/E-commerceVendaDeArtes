  ...
  const bancos = [
    {
      nome: "PayPal",
      descricao:
        "Receba pagamentos via PayPal. Para vender, conecte uma conta empresarial PayPal.",
      botao: "Ver detalhes",
    ...
    },
    {
      ...
      descricao: "Receba via Pix ou boleto bancário.",
      botao: "Conectar",
      icone: "/icons/bb.png",
    },
    {
      nome: "Bradesco",
      descricao: "Aceita Pix e cartão de crédito via Bradesco.",
      botao: "Conectar",
      icone: "/icons/bradesco.png",
    },
    {
      nome: "Caixa",
      descricao: "Ideal para contas poupança ou benefícios sociais.",
      botao: "Conectar",
    ...
    },
    {
      nome: "Santander",
      descricao:
        "Receba via Pix ou cartão através do Getnet. Integra com contas Santander.",
      botao: "Conectar",
  ...
  return (
    <section className={styles.pagamentos_container}>
        ...
        {bancos.map((b) => (
          <button
            ...
            className={`${styles.selector_button} ${
              metodoSelecionado === b.nome ? styles.selected : ""
            }`}
      ...
      <div className={styles.section}>
        <h3>Moeda:</h3>
        <p>
          Escolha a moeda em que seus clientes irão pagar. Alterar a moeda não
          afeta comissões já existentes.
        </p>
